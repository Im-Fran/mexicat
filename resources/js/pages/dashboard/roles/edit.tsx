...
const EditRole = ({ role, allPermissions }: EditRoleProps) => {
    const breadcrumbs: BreadcrumbItem[] = [
        ...
        {
            title: 'Editar Rol',
            href: route('dashboard.roles.edit', { role: role.id }),
        },
    ];
    ...
    const handleSubmit = (e: FormEvent) => {
        e.preventDefault();
        patch(route('dashboard.roles.update', { role: role.id }));
    };
    ...
    return (
        <DashboardLayout breadcrumbs={breadcrumbs}>
            ...
            <div className="p-5">
                <h1 className="text-2xl font-bold mb-5">Editar Rol</h1>
